...
public class IO {
    static String inFileStr = "/Users/sachinsharma/IdeaProjects/Java-In-Depth/walden.png";
    static String outFileStr = "/Users/sachinsharma/IdeaProjects/Java-In-Depth/walden-out.jpg";
...
//        private String gender;
    ...
    */
    ...
    public static void fileMethodsDemo() {
        ...
        File f = new File("newWalden.jpg"); // "movies\\movies.txt" also works
        ...
        try {
            ...
            System.out.println("f2.renameTo(...): " + f2.renameTo(new File("testdir\\temp.txt"))); // move!!
        } catch (IOException e) {}
    ...
    public void doSerialization() {
        ...
        try (ObjectOutputStream out = new ObjectOutputStream(new BufferedOutputStream(new FileOutputStream("/Users/sachinsharma/IdeaProjects/Java-In-Depth/serial.ser")))) {
    ...
    public void doDeserialization() {
        ...
        try (ObjectInputStream in = new ObjectInputStream(new BufferedInputStream(new FileInputStream("/Users/sachinsharma/IdeaProjects/Java-In-Depth/serial.ser")))) {
    ...
    public static void encodingSync() {
		try (BufferedReader br = new BufferedReader(new InputStreamReader(new FileInputStream("/Users/sachinsharma/IdeaProjects/Java-In-Depth/encoding.txt"), "UTF-16BE"))){
        ...
        try {
            ...
            System.out.println(new String("\uD83D\uDE02".getBytes("US-ASCII"), "UTF-16BE"));
        } catch (UnsupportedEncodingException e) {
            // TODO Auto-generated catch block
            e.printStackTrace();
        }
...
//			new IO().doSerialization();
//		}
//		new IO().doDeserialization();
